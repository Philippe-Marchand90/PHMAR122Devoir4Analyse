...
# --- Figure 2 
    ...
    plt.xlabel('h')
    plt.ylabel('E(h)')
    plt.xlim(1e-5, 1.2e-2)  # élargir la plage X pour voir le point h=10⁻²
    plt.ylim(1e-13, 1e-5)  # élargir verticalement pour voir le point h=10⁻²  # étendre vers le bas pour voir le point h=1e-5
